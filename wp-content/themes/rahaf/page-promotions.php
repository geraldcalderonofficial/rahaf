...
<div class="tm-wrap tm-table" style="margin-top: 20px;">
                                ...
                                <div class="page-content" style="padding: 0px 15px 0px 25px;">
                                    <p>From now till Aug 9, enjoy special offer at $198 to redeem a 4.5L Mini Hot & Ambient Water Dispenser <br/>upon purchase of 2 pieces Rahaf Pure Distilled Water </p>
                                    
                                        <div class="tm-column tm5">
                                                <img alt="img" src="<?php bloginfo( 'template_url' );?>/assets/img/aboutus/promo1.jpg" style="width:350px">


                                        </div>
                                            <div class="tm-column tm7" style="float: right">
                                                    <div style="float: left; margin-right: 40px;">
                                                         <img alt="img" src="<?php bloginfo( 'template_url' );?>/assets/img/aboutus/promo2.jpg"  style="width:350px"> 
                                   ...
                                   <br />
                                   <p>Visit Rahaf Water facebook fan page to join and have a discount in buying our products!</p>
                                   <h2>--- Join the Community</h2>
                                   <p>We're not the only ones who care about a world of good. <br />Join others on our community pages.
                                       Like us on <a href="https://www.facebook.com/rahafcompany?fref=nf" target="_blank">Facebook.</a> 
                                       Follow us on <a href="https://twitter.com/rahafcompany" target="_blank">Twitter.</a></p>
