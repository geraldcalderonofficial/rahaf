...
<link rel="stylesheet" id="socastcms_programScheduleGrid_style-css" href="<?php bloginfo( 'template_url' );?>/assets/css/sched/programScheduleGrid.css" type="text/css" media="all">
			...
			<div id="tm-blog" class="tm-container tm-wrap tm-blog-style-list tm-sidebar-right">
					...
					<div class="tm-content page-content-inner" style="min-height: 665px;">
                                                    ...
                                                    <div style="padding: 20px; ">
                                                        ...
                                                        <h2 class="tm-title">FM104 On Air Schedule</h2>
                                                            <div id="programSchedule_1827744652" class="programScheduleGrid">
                                        <div class="controls">
                                                <a class="prev" href="javascript:progGrid_1827744652_shiftLeft()"><img src="<?php bloginfo( 'template_url' );?>/assets/img/sample/home/programSchedule_prev.png"></a>
                                                <a class="today" href="javascript:progGrid_1827744652_shiftLeft(7)"><img src="<?php bloginfo( 'template_url' );?>/assets/img/sample/home/programSchedule_today.png"></a>
                                                <a class="next" href="javascript:progGrid_1827744652_shiftRight()"><img src="<?php bloginfo( 'template_url' );?>/assets/img/sample/home/programSchedule_next.png"></a>
                                        </div>
                                        <div class="progGrid">
                                                <div class="hours">
